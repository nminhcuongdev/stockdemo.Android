...
import com.example.stockdemo.domain.usecase.stock.GetDOByQrCodeUseCase
import com.example.stockdemo.domain.usecase.stock.GetLocationByQrCodeUseCase
import com.example.stockdemo.domain.usecase.stock.GetStockByQrCodeUseCase
import com.example.stockdemo.domain.usecase.stock.GetStocksUseCase
import com.example.stockdemo.domain.usecase.stock.StockInUseCase
import com.example.stockdemo.domain.usecase.stock.UpdateQuantityUseCase
...
class StockViewModel @Inject constructor(
    ...
    private val getDOByQrCodeUseCase: GetDOByQrCodeUseCase,
    ...
    fun getDObyQrcode(qrCode: String) {
        getDOByQrCodeUseCase(qrCode).onEach { result ->
            when (result) {
                is Resource.Success -> {
