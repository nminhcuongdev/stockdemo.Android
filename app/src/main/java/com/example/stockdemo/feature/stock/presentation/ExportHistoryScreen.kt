...
fun ExportHistoryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.export_history_title), fontWeight = FontWeight.Bold) },
                navigationIcon = {
...
fun ExportEmptyState() {
    Column(
        ...
        Text(stringResource(R.string.history_export_empty), fontSize = 18.sp, color = Color.Gray)
    }
}
